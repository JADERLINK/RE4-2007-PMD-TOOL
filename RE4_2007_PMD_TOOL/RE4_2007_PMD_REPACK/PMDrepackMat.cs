...
namespace RE4_2007_PMD_REPACK
{
    public static class PMDrepackMat
    {
        ...
        public static IntermediaryNodeGroup[] GetIntermediaryNodeGroups(PmdNodeGroup[] nodeGroups)
        {
            ...
            {
                IntermediaryNodeGroup group = new IntermediaryNodeGroup();
                group.GroupName = nodeGroups[i].GroupName;
                group.SkeletonIndex = nodeGroups[i].SkeletonIndex;
                group.MaterialList = nodeGroups[i].MaterialList;
                res[i] = group;
            }
            return res;
        }
